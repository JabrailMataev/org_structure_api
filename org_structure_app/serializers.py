...
def validate_functional(value, Error_name):
...
class DepartmentSerializer(serializers.ModelSerializer):
    ...
    def get_children(self, obj):
        ...
        return DepartmentSerializer(children, many=True, context={'depth': depth - 1, 'include_employees': self.context.get('include_employees', True)}).data
    ...
    def validate(self, data):
        ...
        if parent and Department.objects.filter(parent=parent, name=name).exists():
